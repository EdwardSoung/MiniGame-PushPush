...
> 선택한 경로의 Excel 파일을 로드하여 Json으로 변환 기능(dll)<br>
...
<br>
<h3>게임 플레이</h3>
- 이동 : WSAD로 상하좌우 이동 가능<br>
- 점프 : 스페이스로 점프 가능<br>
- 마우스 : 이동에 따라 캐릭터 및 카메라 회전<br>
- 스킬 : Q 키를 누른상태에서 게이지 생성 -> 키를 뗄 때의 수치를 반영하여 주변에 충격파 발생<br>
- 게임 목적 : 제한시간 동안 랜덤으로 생성되는 물건을 밖으로 많이 떨어뜨려 점수를 획득<br>
<br>
